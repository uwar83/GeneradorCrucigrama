 ...
 */
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener, Serializable {
    ...
    public void adjustColumn(final int column) {
        ...
        //if (! tableColumn.getResizable()) return; //REMOVIDO PARA OPTIMIZACION
    ...
    private void updateTableColumn(int column, int width) {
        ...
        //if (! tableColumn.getResizable()) return;//REMOVIDO POR OPTIMIZACION
        width += spacing;
    ...
    public void tableChanged(TableModelEvent e) {
        ...
        if (e.getType() == TableModelEvent.UPDATE) {
            ...
            if (isOnlyAdjustLarger) {
                ...
                if (tableColumn.getResizable())// REMOVIDO POR OPTIMIZACION
                {
                    int width = getCellDataWidth(row, column);
                    updateTableColumn(column, width);
                }// REMOVIDO POR OPTIMIZACION
